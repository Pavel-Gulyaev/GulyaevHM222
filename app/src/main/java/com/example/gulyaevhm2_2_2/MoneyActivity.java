        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBankCardChkBx.isChecked()) {
                    s = " " + mBankCardChkBx.getText().toString() + " ";
                }
                if (mMobilePhoneChkBx.isChecked()) {
                    s = " " + mMobilePhoneChkBx.getText().toString() + " ";
                }
                if (mCashAddressChkBx.isChecked()) {
                    s = " " + mCashAddressChkBx.getText().toString() + " ";
                }
                String massage = "Оплата в размере " + mInputMoney.getText() + s + mInputInfo.getText();
                Toast.makeText(MoneyActivity.this, massage, Toast.LENGTH_LONG).show();
            }
        });
    }
